/**
 * Core stock data structure containing fundamental and technical metrics.
 * Collected from Yahoo Finance, Finnhub, StockTwits, and Reddit APIs.
 */
...
/**
 * Stock with conviction score (0-100) and risk/reward metrics.
 * Generated by scoring model that weights 10 fundamental + technical signals.
 */
...
/**
 * Complete scan report with top stocks, rankings, and executive summary.
 * Generated hourly during market hours (9:30am-4pm ET) and compiled daily.
 */
